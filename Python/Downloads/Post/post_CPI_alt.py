...
def main(output_folder):
    url = 'https://warp.da.ndl.go.jp/info:ndljp/pid/11423429/www.stat.go.jp/data/chouki/zuhyou/22-13.xls'
    ...
    df = df.loc[10:66, [0, 1, 4, 7]]

    # Set the column name
    df.columns = ['year_jpn', 'year_wst', 'cpi_goods', 'cpi_agr']
